...
**Hak redistribusi aset:** pada 22 September 2026 owner menyatakan seluruh aset dalam `public/` boleh didistribusikan melalui repository GitHub publik ini. Ini adalah otorisasi owner untuk workflow repository, bukan audit lisensi independen. Catatan historis di `public/audio/bgm/arunika/README.md` dan `public/assets/characters/female-rpg/credits.txt` menunjukkan bahwa asal-usul/hak pihak ketiga tertentu belum diverifikasi secara terpisah; developer yang menambah, mengganti, atau mendistribusikan ulang aset tetap perlu meninjau provenance dan kewajiban atribusinya. Jangan menyimpulkan izin dari nama folder atau fakta bahwa aset pernah digunakan lokal.
