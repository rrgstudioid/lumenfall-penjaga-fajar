...
export const BLADE_MASTER_V3_SKILLS: readonly SkillDefinitionV3[] = [
  ...
  },
  {
    ...
    baseDamageMinByRank: [100,106,112,118,124,131,138,145], baseDamageMaxByRank: [150,157,164,171,178,185,192,200], skillPowerFactor: 8, rankPowerFactorByRank: [1,1.05,1.1,1.15,1.2,1.25,1.3,1.35],
  ...
  },
  {
    ...
    baseDamageMinByRank: [80,89,98,106,115], baseDamageMaxByRank: [120,130,140,150,160], skillPowerFactor: 8, rankPowerFactorByRank: [1,1.05,1.1,1.15,1.2],
  ...
  },
  {
    ...
    baseDamageMinByRank: [90,100,110,120,130], baseDamageMaxByRank: [135,146,158,169,180], skillPowerFactor: 8, rankPowerFactorByRank: [1,1.05,1.1,1.15,1.2],
  ...
  },
  {
    ...
    baseDamageMinByRank: [140,154,168,181,195], baseDamageMaxByRank: [200,218,235,253,270], skillPowerFactor: 8, rankPowerFactorByRank: [1,1.05,1.1,1.15,1.2],
  ...
  },
  {
    ...
    baseDamageMinByRank: [150,165,180,195,210], baseDamageMaxByRank: [210,230,250,270,290], skillPowerFactor: 8, rankPowerFactorByRank: [1,1.05,1.1,1.15,1.2],
  ...
  },
  {
    ...
    baseDamageMinByRank: [220,260,300], baseDamageMaxByRank: [300,350,400], skillPowerFactor: 10, rankPowerFactorByRank: [1,1.05,1.1],
    effects: { tags: ['blade-master-damage','dual-sequence','flow-eligible','no-stun','no-knockback'] },
...
function adapter(definition: SkillDefinitionV3): SkillDefinition {
  ...
  return {
    ...
    baseDamageMinByRank: definition.baseDamageMinByRank, baseDamageMaxByRank: definition.baseDamageMaxByRank, skillPowerFactor: definition.skillPowerFactor, rankPowerFactorByRank: definition.rankPowerFactorByRank,
