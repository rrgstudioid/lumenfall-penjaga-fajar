...
export const BERSERKER_V3_SKILLS: readonly SkillDefinitionV3[] = [
  ...
  makeDamage({
    id: 'v3-berserker-crushing-blow', name: 'Crushing Blow', maxRank: 5, rankLevelRequirements: [61, 65, 69, 74, 79],
  ...
  {
    id: 'v3-berserker-iron-blood', name: 'Iron Blood', jobId: 'berserker', jobTier: 'specialization', unlockLevel: 62, maxRank: 5,
    rankLevelRequirements: [62, 66, 70, 75, 80], spCostPerRank: 3, skillType: 'ACTIVE_BUFF', targeting: { targetType: 'self' },
  ...
  makeArea({
    id: 'v3-berserker-breaker-entry', name: 'Breaker Entry', maxRank: 5, rankLevelRequirements: [63, 67, 71, 75, 79],
  ...
  makeArea({
    id: 'v3-berserker-ruinous-arc', name: 'Ruinous Arc', maxRank: 5, rankLevelRequirements: [68, 71, 74, 77, 80],
  ...
  {
    id: 'v3-berserker-trance', name: 'Berserker Trance', jobId: 'berserker', jobTier: 'specialization', unlockLevel: 75, maxRank: 3,
    rankLevelRequirements: [75, 78, 80], spCostPerRank: 5, skillType: 'ULTIMATE', weaponRequirement: twoHand, targeting: { targetType: 'self' },
...
const arrays: Record<string, { coefficients: number[]; str: number[]; mana: number[]; cooldown: number[]; radius?: number[]; maxTargets?: number[] }> = {
